    ...
    <div class="col-md-12">
        ...
        <fieldset class="well">
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <?php echo $form->dropDownList($transaksi, 'idCurrency', Yii::app()->util->getKodeStandar(array('modul' => 'mataUang', 'data' => 'all&blank')), array('class' => 'form-control chzn-select')); ?>
        ...
        <fieldset class="well">
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <?php echo $form->dropDownList($transaksi, 'idCurrencyInstructedAmount', Yii::app()->util->getKodeStandar(array('modul' => 'mataUang', 'data' => 'all&blank')), array('class' => 'form-control chzn-select')); ?>
