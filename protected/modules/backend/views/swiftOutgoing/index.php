                                    ...
                                    foreach ($data as $d):
                                        ...
                                        <tr>
                                            ...
                                            <td class="list-actions">
                                                ...
                                                <?php endif; ?>
                                                <?php if ($admin->hasPermissions('swiftOutgoing.exportExcel')): ?>
                                                    <a href="<?php echo $this->vars['backendUrl']; ?>swiftOutgoing/exportExcel/<?php echo $d->id; ?>" class="btn btn-xs btn-default bootip" title="Export to Excel"><span class="icon icon-file"></span></a>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
