...
<div class="form-wrapper">
    ...
    <div class="col-md-12">
        ...
        <fieldset>
            ...
            <fieldset><legend>Kewarganegaraan</legend>
                <div class="form-group">
...
<!--            <fieldset>
            ...
            <fieldset><legend>Nilai Transaksi</legend>
                <div class="form-group">
                    <?php echo $form->labelEx($nasabahPeroranganLn, 'nilaiTransaksiDalamRupiah', array('class' => 'col-md-2 control-label')); ?>
                    <div class="col-md-5">
                        <?php echo $form->textField($nasabahPeroranganLn, 'nilaiTransaksiDalamRupiah', array('class' => 'form-control')); ?>
                        <?php echo $form->error($nasabahPeroranganLn, 'nilaiTransaksiDalamRupiah'); ?>
                    </div>
                </div>
            </fieldset>
    </div>
