...
$title = 'Incomplete Nasabah Perorangan';
                            ...
                            <form method="get">
                                <div class="col-md-4 col-sm-4 col-xs-4">
                                    ...
                                    if ($currentPage > 1)
                                        $disabled = '';
                                    ?>
                                    <a href="<?php echo $this->vars['backendUrl']; ?>incompleteNasabahPerorangan?page=<?php echo $goto; ?>&<?php echo $qs; ?>" class="btn btn-warning btn-sm btn-block <?php echo $disabled; ?> bootip" title="Previous page"><span class="icon icon-chevron-left"></span></a>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-4">
                                    ...
                                    if ($currentPage < $pages->pageCount)
                                        $disabled = '';
                                    ?>
                                    <a href="<?php echo $this->vars['backendUrl']; ?>incompleteNasabahPerorangan?page=<?php echo $goto; ?>&<?php echo $qs; ?>" class="btn btn-warning btn-sm btn-block <?php echo $disabled; ?> bootip" title="Next page"><span class="icon icon-chevron-right"></span></a>
                                </div>
                    ...
                    <div class="panel panel-default panel-backend">
                        ...
                        <div class="panel-body">
                            <form method="get" class="form-filter">
                                ...
                                <div class="form-group">
                                    <input class="form-control" type="text" name="Filter[namaLengkap]" placeholder="Nama Lengkap contains ..." value="<?php echo $filters['namaLengkap']; ?>">
                                </div>
                                <div class="form-group">
                                    <input class="form-control datepicker" type="text" name="Filter[tglLahir_start]" placeholder="Created between ..." value="<?php echo $filters['tglLahir_start']; ?>" readonly="readonly" data-date-format="yyyy-mm-dd">
                                </div>
                                <div class="form-group">
                                    <input class="form-control datepicker" type="text" name="Filter[tglLahir_end]" placeholder="... until ..." value="<?php echo $filters['tglLahir_end']; ?>" readonly="readonly" data-date-format="yyyy-mm-dd">
                                </div>
                                <hr>
