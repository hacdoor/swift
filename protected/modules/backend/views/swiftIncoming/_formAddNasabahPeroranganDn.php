    ...
    <div class="col-md-12">
        ...
        <fieldset><legend>Kewarganaegaraan</legend>
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <?php echo $form->dropDownList($nasabahPeroranganDn, 'wargaNegara', Yii::app()->util->getKodeStandar(array('modul' => 'kewarganegaraan', 'data' => 'all&blank')), array('class' => 'form-control')); ?>
        ...
        <fieldset>
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <?php echo $form->dropDownList($nasabahPeroranganDn, 'pekerjaan', Yii::app()->util->getKodeStandar(array('modul' => 'pekerjaan', 'data' => 'all&blank')), array('class' => 'form-control')); ?>
        ...
        <fieldset><legend>Alamat Sesuai Bukti Identitas</legend>
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <?php echo $form->dropDownList($nasabahPeroranganDn, 'idPropinsiIdentitas', Yii::app()->util->getKodeStandar(array('modul' => 'propinsi', 'data' => 'all&blank')), array('class' => 'form-control')); ?>
