        ...
        <div class="col-md-12">
            ...
            <fieldset class="well">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <?php echo $form->dropDownList($nasabahPeroranganDn, 'wargaNegara', Yii::app()->util->getKodeStandar(array('modul' => 'kewarganegaraan', 'data' => 'all&blank')), array('class' => 'form-control chzn-select')); ?>
            ...
            <fieldset class="well">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <?php echo $form->dropDownList($nasabahPeroranganDn, 'idKabKotaDomisili', Yii::app()->util->getKodeStandar(array('modul' => 'kabupaten', 'data' => 'all&blank')), array('class' => 'form-control chzn-select')); ?>
            ...
            <fieldset class="well">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <?php echo $form->dropDownList($nasabahPeroranganDn, 'idPropinsiIdentitas', Yii::app()->util->getKodeStandar(array('modul' => 'propinsi', 'data' => 'all&blank')), array('class' => 'form-control chzn-select')); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <?php echo $form->dropDownList($nasabahPeroranganDn, 'idKabKotaIdentitas', Yii::app()->util->getKodeStandar(array('modul' => 'kabupaten', 'data' => 'all&blank')), array('class' => 'form-control chzn-select')); ?>
