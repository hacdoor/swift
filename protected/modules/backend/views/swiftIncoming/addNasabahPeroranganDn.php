        ...
        <div id="content-inner" class="noBorderTop">
            ...
            <div class="innerGrid">
                ...
                <?php if (isset($_GET['update_id'])) : ?>
                    <a href="<?php echo $this->vars['backendUrl'] . 'swiftIncoming/addPenerimaNasabahPerorangan/' . $model->id; ?>" type="text" class="btn btn-default"><i class="icon-plus"></i> Tambah Penerima</a>
                <?php endif; ?>
