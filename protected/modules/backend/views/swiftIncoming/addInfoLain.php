...
<div class="row">
    <div class="col-md-12">
        ...
        <div id="content-inner" class="noBorderTop">
            <h1 class="page-title">
                <span class="icon-plus"></span> <?php echo $infoLain->isNewRecord ? 'Tambah' : 'Update'; ?> Informasi Lain Swift Incoming
            ...
            <div class="row">
                <?php echo $this->renderPartial('_formAddInfoLain', array('infoLain' => $infoLain)); ?>
            </div>
        </div>
    </div>
</div>