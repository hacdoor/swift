    ...
    <ul class="nav nav-tabs">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu" role="menu">
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        Perorangan <span class="icon-caret-right caret-sub pull-right"></span>
                    </a>
        ...
        <li class="dropdown <?php if ($this->action->id == 'addPenerimaNasabahPerorangan'): ?>active<?php endif; ?>">
            <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                Identitas Penerima <span class="caret"></span>
            </a>
            <ul class="dropdown-menu" role="menu">
                <?php if ($model->pjkBankSebagai == 1) : ?>
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                            Perorangan <span class="icon-caret-right caret-sub pull-right"></span>
                        </a>
                    ...
                    <li><a href="<?php echo $this->vars['backendUrl'] . 'swiftIncoming/addPenerimaNasabahKorporasi/' . $model->id; ?>">Non Nasabah</a></li>
                <?php else: ?>
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                            Perorangan <span class="icon-caret-right caret-sub pull-right"></span>
