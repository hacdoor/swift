            ...
            <div class="row">
                <div class="col-md-10">
                    ...
                    <div class="btn-action">
                        <?php echo CHtml::submitButton('Finalize', array('name' => 'FinalizeButton', 'confirm' => 'Are you sure want to finalize this record?', 'class' => 'btn btn-lg btn-default bootip', 'title' => 'Set to Finalize')); ?>
