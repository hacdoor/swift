<?php
$title = $nasabahPeroranganLn->isNewRecord ? '<span class="icon-plus"></span> Tambah' : '<span class="icon-pencil"></span> Update';
        ...
        <div id="content-inner" class="noBorderTop">
            ...
            <div class="innerGrid">
                ...
                <?php if (isset($_GET['update_id'])) : ?>
                    <a href="<?php echo $this->vars['backendUrl'] . 'nonSwiftOutgoing/addPenerimaNasabahPerorangan/' . $model->id; ?>" type="text" class="btn btn-default"><i class="icon-plus"></i> Tambah Penerima</a>
                <?php endif; ?>
                ...
                $this->widget('zii.widgets.grid.CGridView', array(
                    ...
                    'columns' => array(
                        ...
                        'alamat',
                        array(
                            'name' => 'idNegaraVoucher',
                            'header' => 'Negara',
                            'value' => '$data->idNegaraVoucher0->nama',
                            'type' => 'raw',
                        ),
                        array(
                            'class' => 'CButtonColumn',
            ...
            <?php echo $this->renderPartial('_formAddNasabahPeroranganLn', array('nasabahPeroranganLn' => $nasabahPeroranganLn)); ?>
