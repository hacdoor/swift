...
$title = 'Daftar Non Swift Outgoing';
        ...
        <div id="content-inner">
            ...
            <div class="row">
                <div class="col-md-10">
                    ...
                    <div class="btn-group pull-right hidden">
                        <?php if (isset($_GET['Filter']) || isset($_GET['sort'])): ?>
                            <a href="<?php echo $this->vars['backendUrl']; ?>nonSwiftOutgoing" class="btn btn-default btn-lg"><span class="icon icon-refresh"></span> Reset</a>
                        <?php endif; ?>
                                    ...
                                    foreach ($data as $d):
                                        ...
                                        <tr>
                                            ...
                                            <td class="list-actions">
                                                <?php if ($admin->hasPermissions('nonSwiftOutgoing.update')): ?>
                                                    <a href="<?php echo $this->vars['backendUrl']; ?>nonSwiftOutgoing/umum/<?php echo $d->id; ?>" class="btn btn-xs btn-default bootip" title="Update"><span class="icon icon-pencil"></span></a>
                                                <?php endif; ?>
                                                <?php if ($admin->hasPermissions('nonSwiftOutgoing.generateExcel')): ?>
                                                    <a href="<?php echo $this->vars['backendUrl']; ?>nonSwiftOutgoing/createExcel/<?php echo $d->id; ?>" class="btn btn-xs btn-default bootip" title="Export to Excel"><span class="icon icon-file"></span></a>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                ...
                <div class="col-md-2">
                    ...
                    <?php if ($admin->hasPermissions('nonSwiftOutgoing.create')): ?>
                        <a href="<?php echo $this->vars['backendUrl']; ?>nonSwiftOutgoing/create" class="btn btn-primary btn-lg btn-block"><span class="icon icon-plus"></span> Buat Baru</a>
                        <hr>
                    <?php endif; ?>
                            ...
                            <form method="get">
                                <div class="col-md-4 col-sm-4 col-xs-4">
                                    ...
                                    if ($currentPage > 1)
                                        $disabled = '';
                                    ?>
                                    <a href="<?php echo $this->vars['backendUrl']; ?>nonSwiftOutgoing?page=<?php echo $goto; ?>&<?php echo $qs; ?>" class="btn btn-warning btn-sm btn-block <?php echo $disabled; ?> bootip" title="Previous page"><span class="icon icon-chevron-left"></span></a>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-4">
                                    ...
                                    if ($currentPage < $pages->pageCount)
                                        $disabled = '';
                                    ?>
                                    <a href="<?php echo $this->vars['backendUrl']; ?>nonSwiftOutgoing?page=<?php echo $goto; ?>&<?php echo $qs; ?>" class="btn btn-warning btn-sm btn-block <?php echo $disabled; ?> bootip" title="Next page"><span class="icon icon-chevron-right"></span></a>
                                </div>
