                                ...
                                if ($data):
                                    ...
                                    foreach ($data as $d):
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo Yii::app()->util->purify($d->propinsi->nama); ?></td>
                                            <td class="list-actions">
                                                <?php if ($admin->hasPermissions('kabupaten.update')): ?>
                                                    <a href="<?php echo $this->vars['backendUrl']; ?>kabupaten/update/<?php echo $d->id; ?>" class="btn btn-xs btn-default bootip" title="Update"><span class="icon icon-pencil"></span></a>
                                                <?php endif; ?>
                                                <?php if ($admin->hasPermissions('kabupaten.delete')): ?>
                                                    <a href="<?php echo $this->vars['backendUrl']; ?>kabupaten/delete/<?php echo $d->id; ?>" class="btn btn-xs btn-default btn-delete bootip" title="Delete" data-confirm="Are you sure want to delete this record?"><span class="icon icon-trash"></span></a>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                            ...
                            <form method="get">
                                <div class="col-md-4 col-sm-4 col-xs-4">
                                    ...
                                    if ($currentPage > 1)
                                        $disabled = '';
                                    ?>
                                    <a href="<?php echo $this->vars['backendUrl']; ?>kabupaten?page=<?php echo $goto; ?>&<?php echo $qs; ?>" class="btn btn-warning btn-sm btn-block <?php echo $disabled; ?> bootip" title="Previous page"><span class="icon icon-chevron-left"></span></a>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-4">
                                    ...
                                    if ($currentPage < $pages->pageCount)
                                        $disabled = '';
                                    ?>
                                    <a href="<?php echo $this->vars['backendUrl']; ?>kabupaten?page=<?php echo $goto; ?>&<?php echo $qs; ?>" class="btn btn-warning btn-sm btn-block <?php echo $disabled; ?> bootip" title="Next page"><span class="icon icon-chevron-right"></span></a>
                                </div>
                                <input type="hidden" name="Filter[nama]" value="<?php echo $filters['nama']; ?>">
                                <input type="hidden" name="Filter[propinsi]" value="<?php echo $filters['propinsi']; ?>">
                            </form>
                        </div>
                    <?php endif; ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control chzn-select" data-placeholder="Pilih Propinsi" id="search-by-Propinsi" name="Filter[propinsi]">
                                        ...
                                        <?php foreach ($listData as $c): ?>
                                            <?php
                                            $sel = '';
                                            if (intval($c->id) == intval($filters['propinsi']))
