...
class Transaksi extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('id, tglTransaksi, timeIndication, sendersReference, relatedReference, bankOperationCode, instructionCode, kanCabPenyelenggaraPengirimAsal, typeTransactionCode, valueDate, amount, idCurrency, currencyLain, currencyLainInstructedAmount, amountDalamRupiah, idCurrencyInstructedAmount, instructedAmount, exchangeRate, sendingInstitution, beneficiaryInstitution, tujuanTransaksi, sumberDana, swift_id', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function search() {
        ...
        $criteria->compare('currencyLain', $this->currencyLain);
        ...
        $criteria->compare('currencyLainInstructedAmount', $this->currencyLainInstructedAmount);
